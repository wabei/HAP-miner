// Objective-C API for talking to github.com/wabei/go-wabei/mobile Go package.
//   gobind -lang=objc github.com/wabei/go-wabei/mobile
//
...
- (GethWabeiClient*)getWabeiClient:(NSError**)error;
...
- (BOOL)wabeiEnabled;
- (void)setWabeiEnabled:(BOOL)v;
- (int64_t)wabeiNetworkID;
- (void)setWabeiNetworkID:(int64_t)v;
- (NSString*)wabeiGenesis;
- (void)setWabeiGenesis:(NSString*)v;
- (long)wabeiDatabaseCache;
- (void)setWabeiDatabaseCache:(long)v;
- (NSString*)wabeiNetStats;
- (void)setWabeiNetStats:(NSString*)v;
- (BOOL)whisperEnabled;
...
@interface GethWabeiClient : NSObject <goSeqRefInterface> {
}
@property(strong, readonly) id _ref;
...
FOUNDATION_EXPORT GethBoundContract* GethBindContract(GethAddress* address, NSString* abiJSON, GethWabeiClient* client, NSError** error);

FOUNDATION_EXPORT GethBoundContract* GethDeployContract(GethTransactOpts* opts, NSString* abiJSON, NSData* bytecode, GethWabeiClient* client, GethInterfaces* args, NSError** error);
...
FOUNDATION_EXPORT GethWabeiClient* GethNewWabeiClient(NSString* rawurl, NSError** error);
